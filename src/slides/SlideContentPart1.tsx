        ...
        <div style={{ 
          ...
          <svg width="100%" height="100%" viewBox="0 0 800 400" style={{ filter: 'drop-shadow(0 0 20px rgba(0,0,0,0.5))' }}>
            ...
            <g transform="translate(150, 200)">
              ...
              <text x="0" y="0" fill="white" textAnchor="middle" fontSize="18" fontWeight="bold">{lang === 'en' ? 'Museum A' : 'M�ze A'}</text>
            ...
            <g transform="translate(650, 200)">
              <rect x="-60" y="-40" width="120" height="80" rx="8" fill="rgba(255,255,255,0.05)" stroke="var(--text-secondary)" strokeWidth="2" />
              <text x="0" y="0" fill="white" textAnchor="middle" fontSize="18" fontWeight="bold">{lang === 'en' ? 'Museum B' : 'M�ze B'}</text>
              <circle cx="-60" cy="0" r="6" fill="var(--accent-color)" />
            </g>
          ...
          <svg width="100%" height="100%" viewBox="0 0 800 280" preserveAspectRatio="xMidYMid meet">
            ...
            <g style={{ opacity: !isFederated ? 1 : 0, transition: 'opacity 0.5s ease', pointerEvents: !isFederated ? 'auto' : 'none' }}>
              ...
              <g transform="translate(600, 140)">
                ...
                <text x="0" y="-100" fill="var(--state-warning)" textAnchor="middle" fontSize="16" fontWeight="bold">{lang === 'en' ? 'Central Aggregator' : 'Merkezi Toplay�c�'}</text>
                <text x="0" y="-10" fill="white" textAnchor="middle" fontSize="14">{lang === 'en' ? 'Massive DB' : 'Devasa Veritaban�'}</text>
            ...
            <g style={{ opacity: isFederated ? 1 : 0, transition: 'opacity 0.5s ease', pointerEvents: isFederated ? 'auto' : 'none' }}>
              ...
              {[150, 400, 650].map((x, i) => (
                <g key={`fed-mus-${i}`} transform={`translate(${x}, 60)`}>
                  ...
                  <text x="0" y="5" fill="white" textAnchor="middle" fontSize="12">{lang === 'en' ? 'Local DB' : 'Yerel Veritaban�'}</text>
                </g>
              ))}
              ...
              <g transform="translate(150, 200)">
                ...
                <text x="0" y="45" fill="white" textAnchor="middle" fontSize="14">{lang === 'en' ? 'Curator Query' : 'K�rat�r Sorgusu'}</text>
              </g>
